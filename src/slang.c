...
static const char* token_type_name [] = {
     ...
     "BUFFER_MEMBER_DECLARATION_LIST",// = 436,
     "INIT_DECLARATOR_LIST",// = 437,
     "DECLARATOR",// = 438,
     "EXTERNAL_DECLARATION_SPECIFIERS",// = 439,
     ...
     "STRUCT_INTERPOLATION_MODIFIER_LIST",// = 446,
     "STRUCT_MEMBER_DECLARATION_LIST",// = 447,
     "TYPE_SPECIFIER",// = 448,
     "STATEMENT_BLOCK",// = 449,
     "SEMANTIC",// = 450,
     "TYPEDEF_NAME",// = 451,
     "ENUMERATION_CONSTANT",// = 452,
     "TERNARY_OPERATOR",// = 453,
     "NULL_NODE",// = 454
};
...
void print_slang_node_and_children(slang_node_t* ast_node, FILE* out) {
    if (ast_node) {
        if (ast_node->tokentype == IDENTIFIER) {
            ...
            if (ast_node->declarator.arraySizeChild) {
