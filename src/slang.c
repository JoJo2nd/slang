...
static const char* token_type_name [] = {
    ...
    "CBUFFER_OR_TBUFFER_SPECIFIERS", // = 442,
    "BUFFER_MEMBER_DECLARATION", // = 443,
    "STRUCT_DECL", // = 444,
    "STRUCT_MEMBER_DECL", // = 445,
    "BUFFER_MEMBER_DECLARATION_LIST", // = 446,
    "BUFFER_SPECIFIER_QUALIFIER_LIST", // = 447,
    "BUFFER_DECLARATOR_LIST", // = 448,
    "STRUCT_MEMBER_DECLARATION_LIST", // = 449,
    "STRUCT_SPECIFIER_QUALIFIER_LIST", // = 450,
    "STRUCT_DECLARATOR_LIST", // = 451,
    "TYPE_SPECIFIER", // = 452,
    "STATEMENT_BLOCK", // = 453,
    "SEMANTIC", // = 454,
    "TYPEDEF_NAME", // = 455,
    "ENUMERATION_CONSTANT", // = 456,
    "TERNARY_OPERATOR", // = 457,
    "NULL_NODE", // = 458
};
