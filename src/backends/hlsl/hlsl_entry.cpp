...
static void initialiseActionTable() {
    ...
    //nodeActionTable[DOUBLECONSTANT] = ;
    nodeActionTable[INTCONSTANT] = [](const slang_node_t* node, HLSLContext* ctx) {
        fprintf(ctx->output, "%d ", node->int_const);
        return 0;
    };
    //nodeActionTable[UINTCONSTANT] = ;
    //nodeActionTable[REGISTERCONSTANT] = ;
    //nodeActionTable[STRING_LITERAL] = ;
    //nodeActionTable[TRUE_VALUE] = ;
    //nodeActionTable[FALSE_VALUE] = ;
    //nodeActionTable[VOID] = ;
    //nodeActionTable[FOR] = ;
    //nodeActionTable[IF] = ;
    //nodeActionTable[ELSE] = ;
    //nodeActionTable[DO] = ;
    //nodeActionTable[WHILE] = ;
    //nodeActionTable[CASE] = ;
    //nodeActionTable[DEFAULT] = ;
    //nodeActionTable[BREAK] = ;
    //nodeActionTable[CONTINUE] = ;
    //nodeActionTable[DISCARD] = ;
    //nodeActionTable[SWITCH] = ;
    //nodeActionTable[INLINE] = ;
    //nodeActionTable[RETURN] = ;
    //nodeActionTable[STRUCT] = ;
    //nodeActionTable[CBUFFER] = ;
    //nodeActionTable[TBUFFER] = ;
    //nodeActionTable[BUFFER] = ;
    ...
    //nodeActionTable[EXTERN] = 
    //nodeActionTable[PRECISE] = 
    nodeActionTable[SHARED] = 
    //nodeActionTable[GROUPSHARED] = 
    nodeActionTable[STATIC] = 
    //nodeActionTable[UNIFORM] = 
    //nodeActionTable[VOLATILE] = 
    nodeActionTable[CONST] = 
    nodeActionTable[ROW_MAJOR] = 
    nodeActionTable[COLUMN_MAJOR] = 
    // nodeActionTable[PACKOFFSET] =
    ...
    //nodeActionTable[LEFT_OP] = ;
    //nodeActionTable[RIGHT_OP] = ;
    //nodeActionTable[INC_OP] = ;
    //nodeActionTable[DEC_OP] = ;
    //nodeActionTable[LE_OP] = ;
    //nodeActionTable[GE_OP] = ;
    //nodeActionTable[EQ_OP] = ;
    //nodeActionTable[NE_OP] = ;
    //nodeActionTable[AND_OP] = ;
    //nodeActionTable[OR_OP] = ;
    //nodeActionTable[XOR_OP] = ;
    //nodeActionTable[MUL_ASSIGN] = ;
    //nodeActionTable[DIV_ASSIGN] = ;
    //nodeActionTable[ADD_ASSIGN] = ;
    //nodeActionTable[MOD_ASSIGN] = ;
    //nodeActionTable[LEFT_ASSIGN] = ;
    //nodeActionTable[RIGHT_ASSIGN] = ;
    //nodeActionTable[AND_ASSIGN] = ;
    //nodeActionTable[XOR_ASSIGN] = ;
    //nodeActionTable[OR_ASSIGN] = ;
    //nodeActionTable[SUB_ASSIGN] = ;
    //nodeActionTable[VS] = ;
    //nodeActionTable[PS] = ;
    //nodeActionTable[GS] = ;
    //nodeActionTable[DS] = ;
    ...
    //nodeActionTable[COMPOUND_STATEMENT] = ;
    //nodeActionTable[BLOCK_ITEM_LIST] = ;
    //nodeActionTable[FUNCTION] = ;
    //nodeActionTable[FUNCTION_ARG_LIST] = ;
    //nodeActionTable[FUNCTION_ARG] = ;
    //nodeActionTable[ANNOTATION_LIST] = ;
    ...
    nodeActionTable[INIT_DECLARATOR_LIST] = [](const slang_node_t* node, HLSLContext* ctx) {
    ...
    //nodeActionTable[CBUFFER_TBUFFER_DECL] = ;
    //nodeActionTable[BUFFER_MEMBER_DECLARATION] = ;
    //nodeActionTable[STRUCT_DECL] = ;
    //nodeActionTable[STRUCT_MEMBER_DECL] = ;
    //nodeActionTable[STRUCT_INTERPOLATION_MODIFIER_LIST] = ;
    //nodeActionTable[STRUCT_MEMBER_DECLARATION_LIST] = ;
    //nodeActionTable[TYPE_SPECIFIER] = ;
    //nodeActionTable[STATEMENT_BLOCK] = ;
    //nodeActionTable[SEMANTIC] = ;
    //nodeActionTable[TYPEDEF_NAME] = ;
    //nodeActionTable[ENUMERATION_CONSTANT] = ;
    //nodeActionTable[TERNARY_OPERATOR] = ;
    //nodeActionTable[NULL_NODE] = ;
